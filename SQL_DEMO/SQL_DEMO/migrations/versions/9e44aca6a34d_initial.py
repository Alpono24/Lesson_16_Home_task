...
Revision ID: 9e44aca6a34d
Revises: 
Create Date: 2025-09-27 21:53:32.869633
...
def downgrade() -> None:
    ...
    sa.PrimaryKeyConstraint('state_id', name=op.f('pk_usstates'))
    )
    ...
    sa.ForeignKeyConstraint(['employee_id'], ['employees.employee_id'], name=op.f('fk_employee_territories_employees')),
    sa.ForeignKeyConstraint(['territory_id'], ['territories.territory_id'], name=op.f('fk_employee_territories_territories')),
    sa.PrimaryKeyConstraint('employee_id', 'territory_id', name=op.f('pk_employee_territories'))
    )
    ...
    sa.Column('region_id', sa.SMALLINT(), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['region_id'], ['region.region_id'], name=op.f('fk_territories_region')),
    sa.PrimaryKeyConstraint('territory_id', name=op.f('pk_territories'))
    )
    ...
    sa.ForeignKeyConstraint(['order_id'], ['orders.order_id'], name=op.f('fk_order_details_orders')),
    sa.ForeignKeyConstraint(['product_id'], ['products.product_id'], name=op.f('fk_order_details_products')),
    sa.PrimaryKeyConstraint('order_id', 'product_id', name=op.f('pk_order_details'))
    )
    op.create_table('customer_customer_demo',
    sa.Column('customer_id', sa.VARCHAR(length=5), autoincrement=False, nullable=False),
    sa.Column('customer_type_id', sa.VARCHAR(length=5), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['customer_id'], ['customers.customer_id'], name=op.f('fk_customer_customer_demo_customers')),
    sa.ForeignKeyConstraint(['customer_type_id'], ['customer_demographics.customer_type_id'], name=op.f('fk_customer_customer_demo_customer_demographics')),
    sa.PrimaryKeyConstraint('customer_id', 'customer_type_id', name=op.f('pk_customer_customer_demo'))
    )
    # ### end Alembic commands ###
